...
class ShowTest {
  ...
  @Test
  void testRunEventNotFound() {
    int exitcode = cmd.execute("show", "evt-8389729");

    assertEquals(1, exitcode);
  }

  @Test
  void testRunEventFoundJsonOutput() {
    int exitcode = cmd.execute("show", "evt-835089729", "--json");

    assertEquals(0, exitcode);
  }

  @Test
  void testRunEventFoundPrettyOutput() {
    int exitcode = cmd.execute("show", "evt-835089729");

    assertEquals(0, exitcode);
  }

  @Test
  void testRunEventWithConflicts() {
    int exitcode =
        cmd.execute(
            "--force",
            "edit",
            ...
            "--time",
            "14:00");
    exitcode = cmd.execute("show", "evt--321706463");
